...
const getElement = (e) =>
  isElement(e)
    ...
    : null
const emulateTransitionEnd = (e, t) => {
  let n = !1
  const i = t + 5
...
const isVisible = (e) => {
  ...
  if (e.style && e.parentNode && e.parentNode.style) {
    ...
    return (
      t.display !== 'none' && n.display !== 'none' && t.visibility !== 'hidden'
    )
  }
  return !1
}
...
const Data = {
  ...
  remove(e, t) {
    ...
    n.delete(t), n.size === 0 && elementMap.delete(e)
  },
}
...
function addHandler(e, t, n, i, s) {
  ...
  const l = getEvent(e)
  const c = l[r] || (l[r] = {})
  const E = findHandler(c, a, o ? n : null)
  if (E) return void (E.oneOff = E.oneOff && s)
  const _ = getUidEvent(a, t.replace(namespaceRegex, ''))
  const d = o ? bootstrapDelegationHandler(e, n, i) : bootstrapHandler(e, n)
...
const EventHandler = {
  ...
  trigger(e, t, n) {
    ...
    const i = getjQuery()
    const s = getTypeEvent(t)
    const o = t !== s
    const a = nativeEvents.has(s)
    let r
    let l = !0
    let c = !0
    let E = !1
...
const EVENT_CLOSE = 'close.bs.alert'
const EVENT_CLOSED = 'closed.bs.alert'
const EVENT_CLICK_DATA_API$7 = 'click.bs.alert.data-api'
...
class Alert extends BaseComponent {
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      ...
      t || (t = new Alert(this)), e === 'close' && t[e](this)
    })
  }
...
class Button extends BaseComponent {
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      ...
      t || (t = new Button(this)), e === 'toggle' && t[e]()
    })
  }
}
...
class Carousel extends BaseComponent {
  ...
  _getItemByOrder(e, t) {
    ...
    const i = e === ORDER_PREV
    const s = this._getItemIndex(t)
    const o = this._items.length - 1
    if (((i && s === 0) || (n && s === o)) && !this._config.wrap) return t
  ...
  _slide(e, t) {
    ...
    const i = SelectorEngine.findOne(SELECTOR_ACTIVE_ITEM, this._element)
    const s = this._getItemIndex(i)
    const o = t || this._getItemByOrder(n, i)
    const a = this._getItemIndex(o)
    const r = Boolean(this._interval)
    const l = n === ORDER_NEXT
    const c = l ? CLASS_NAME_START : CLASS_NAME_END
    const E = l ? CLASS_NAME_NEXT : CLASS_NAME_PREV
    const _ = this._orderToDirection(n)
  ...
  static carouselInterface(e, t) {
    ...
    let i = { ...Default$9, ...Manipulator.getDataAttributes(e) }
    typeof t === 'object' && (i = { ...i, ...t })
    const s = typeof t === 'string' ? t : i.slide
    if ((n || (n = new Carousel(e, i)), typeof t === 'number')) n.to(t)
...
const EVENT_KEY$8 = '.bs.collapse'
const DATA_API_KEY$5 = '.data-api'
const Default$8 = { toggle: !0, parent: '' }
const DefaultType$8 = { toggle: 'boolean', parent: '(string|element)' }
...
class Collapse extends BaseComponent {
  constructor(e, t) {
    ...
    for (let e = 0, t = n.length; e < t; e++) {
      const t = n[e]
      const i = getSelectorFromElement(t)
      const s = SelectorEngine.find(i).filter((e) => e === this._element)
      i !== null &&
        s.length &&
...
EventHandler.on(
  ...
  function (e) {
    ...
    const n = getSelectorFromElement(this)
...
const EVENT_CLICK = 'click.bs.dropdown'
...
class Dropdown extends BaseComponent {
  ...
  show() {
    ...
    if (
      ...
      if (this._inNavbar)
        ...
        const i = n.modifiers.find(
          (e) => e.name === 'applyStyles' && !1 === e.enabled
        )
  ...
  _selectMenuItem(e) {
    ...
    e.key === 'ArrowUp' && n > 0 && n--,
      e.key === 'ArrowDown' && n < t.length - 1 && n++,
      (n = n === -1 ? 0 : n),
      t[n].focus()
  }
  ...
  static dropdownInterface(e, t) {
    ...
    if (
      (n || (n = new Dropdown(e, typeof t === 'object' ? t : null)),
      typeof t === 'string')
    ) {
      if (void 0 === n[t]) throw new TypeError(`No method named "${t}"`)
      n[t]()
  ...
  static clearMenus(e) {
    ...
    for (let n = 0, i = t.length; n < i; n++) {
      ...
      if (e) {
        ...
        const n = t.includes(i._menu)
        if (
          t.includes(i._element) ||
          (i._config.autoClose === 'inside' && !n) ||
          (i._config.autoClose === 'outside' && n)
        )
          continue
        if (
  ...
  static dataApiKeydownHandler(e) {
    ...
    if (e.key === 'Escape') return n().focus(), void Dropdown.clearMenus()
    t || (e.key !== 'ArrowUp' && e.key !== 'ArrowDown')
      ? t && e.key !== 'Space'
...
const _setElementAttributes = (e, t, n) => {
  const i = getWidth()
...
const _resetElementAttributes = (e, t) => {
  SelectorEngine.find(e).forEach((e) => {
...
class Backdrop {
  ...
  _getConfig(e) {
    return (
      ((e = { ...Default$6, ...(typeof e === 'object' ? e : {}) }).rootElement =
...
const EVENT_FOCUSIN$2 = 'focusin.bs.modal'
const EVENT_RESIZE = 'resize.bs.modal'
const EVENT_CLICK_DISMISS$2 = 'click.dismiss.bs.modal'
...
class Modal extends BaseComponent {
  ...
  _showElement(e) {
    const t = this._isAnimated()
    const n = SelectorEngine.findOne('.modal-body', this._dialog)
  ...
  _setEscapeEvent() {
    this._isShown
      ? EventHandler.on(this._element, EVENT_KEYDOWN_DISMISS$1, (e) => {
          this._config.keyboard && e.key === 'Escape'
  ...
  static jQueryInterface(e, t) {
    return this.each(function () {
      const n =
        ...
        new Modal(this, typeof e === 'object' ? e : {})
      if (typeof e === 'string') {
...
const EVENT_FOCUSIN$1 = 'focusin.bs.offcanvas'
const EVENT_CLICK_DATA_API$1 = 'click.bs.offcanvas.data-api'
const EVENT_CLICK_DISMISS$1 = 'click.dismiss.bs.offcanvas'
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      const t =
        ...
        new Offcanvas(this, typeof e === 'object' ? e : {})
      if (typeof e === 'string') {
...
const BSCLS_PREFIX_REGEX$1 = new RegExp('(^|\\s)bs-tooltip\\S+', 'g')
...
class Tooltip extends BaseComponent {
  ...
  show() {
    ...
    const t = findShadowRoot(this._element)
    const n =
      t === null
    ...
    const s = getUID(this.constructor.NAME)
    i.setAttribute('id', s),
  ...
  _enter(e, t) {
    ;(t = this._initializeOnDelegatedTarget(e, t)),
      e && (t._activeTrigger[e.type === 'focusin' ? 'focus' : 'hover'] = !0),
      t.getTipElement().classList.contains('show') || t._hoverState === 'show'
        ? (t._hoverState = 'show')
  ...
  _leave(e, t) {
    ;(t = this._initializeOnDelegatedTarget(e, t)),
      e &&
        (t._activeTrigger[e.type === 'focusout' ? 'focus' : 'hover'] =
  ...
  _cleanTipClass() {
    const e = this.getTipElement()
    const t = e.getAttribute('class').match(BSCLS_PREFIX_REGEX$1)
    t !== null &&
      t.length > 0 &&
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      ...
      if (
        ...
        (t || (t = new Tooltip(this, n)), typeof e === 'string')
      ) {
...
const BSCLS_PREFIX_REGEX = new RegExp('(^|\\s)bs-popover\\S+', 'g')
const Default$2 = {
  ...Tooltip.Default,
  placement: 'right',
  offset: [0, 8],
...
class Popover extends Tooltip {
  ...
  _cleanTipClass() {
    const e = this.getTipElement()
    const t = e.getAttribute('class').match(BSCLS_PREFIX_REGEX)
    t !== null &&
      t.length > 0 &&
      t.map((e) => e.trim()).forEach((t) => e.classList.remove(t))
  }
...
class ScrollSpy extends BaseComponent {
  ...
  refresh() {
    ...
    const n = t === 'position' ? this._getScrollTop() : 0
    ;(this._offsets = []),
      (this._targets = []),
      ...
      SelectorEngine.find(this._selector)
        .map((e) => {
          ...
          const s = i ? SelectorEngine.findOne(i) : null
          if (s) {
  ...
  _activate(e) {
    ...
    const n = SelectorEngine.findOne(t.join(','))
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      const t =
        ...
        new ScrollSpy(this, typeof e === 'object' ? e : {})
      if (typeof e === 'string') {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`)
        t[e]()
      }
...
class Tab extends BaseComponent {
  ...
  _activate(e, t, n) {
    ...
    const s = n && i && i.classList.contains('fade')
    const o = () => this._transitionComplete(e, i, n)
...
const EVENT_CLICK_DISMISS = 'click.dismiss.bs.toast'
...
class Toast extends BaseComponent {
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      ...
      if (
        (t || (t = new Toast(this, typeof e === 'object' && e)),
        typeof e === 'string')
      ) {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`)
        t[e](this)
