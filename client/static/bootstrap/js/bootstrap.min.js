...
!(function (t, e) {
  ...
  const A = {
    ...
    remove(t, e) {
      if (!T.has(t)) return
      const s = T.get(t)
      s.delete(e), s.size === 0 && T.delete(t)
    },
  }
  const k = /[^.]*(?=\..*)\.|.*/
  const L = /\..*/
  ...
  class U extends z {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        e || (e = new U(this)), t === 'close' && e[t](this)
      })
    }
  ...
  class J extends z {
    ...
    _keydown(t) {
      ;/input|textarea/i.test(t.target.tagName) ||
        (t.key === 'ArrowLeft'
          ...
          : t.key === 'ArrowRight' && (t.preventDefault(), this._slide(G)))
    }
    ...
    static carouselInterface(t, e) {
      ...
      let i = { ...V, ...K.getDataAttributes(t) }
      typeof e === 'object' && (i = { ...i, ...e })
      const n = typeof e === 'string' ? e : i.slide
      if ((s || (s = new J(t, i)), typeof e === 'number')) s.to(e)
  ...
  const nt = y() ? 'top-end' : 'top-start'
  const ot = y() ? 'top-start' : 'top-end'
  const rt = y() ? 'bottom-end' : 'bottom-start'
  const at = y() ? 'bottom-start' : 'bottom-end'
  const lt = y() ? 'left-start' : 'right-start'
  const ct = y() ? 'right-start' : 'left-start'
  const ht = {
    offset: [0, 2],
  ...
  class ut extends z {
    ...
    _selectMenuItem(t) {
      ...
      t.key === 'ArrowUp' && s > 0 && s--,
        t.key === 'ArrowDown' && s < e.length - 1 && s++,
        (s = s === -1 ? 0 : s),
        e[s].focus()
    }
    ...
    static dropdownInterface(t, e) {
      ...
      if (
        (s || (s = new ut(t, typeof e === 'object' ? e : null)),
        typeof e === 'string')
      ) {
        if (void 0 === s[e]) throw new TypeError(`No method named "${e}"`)
        s[e]()
    ...
    static dataApiKeydownHandler(t) {
      ...
      if (t.key === 'Escape') return s().focus(), void ut.clearMenus()
      e || (t.key !== 'ArrowUp' && t.key !== 'ArrowDown')
        ? e && t.key !== 'Space'
  ...
  class wt {
    ...
    _getConfig(t) {
      return (
        ((t = { ...vt, ...(typeof t === 'object' ? t : {}) }).rootElement =
  ...
  class At extends z {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        const s =
          At.getInstance(this) || new At(this, typeof t === 'object' ? t : {})
        if (typeof t === 'string') {
  ...
  const Lt = { backdrop: 'boolean', keyboard: 'boolean', scroll: 'boolean' }
  class Ct extends z {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
  ...
  const Nt = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/i
  const St =
  ...
  const jt = new Set(['sanitize', 'allowList', 'sanitizeFn'])
  const Pt = {
    animation: 'boolean',
    template: 'string',
  ...
  class Bt extends z {
    ...
    _cleanTipClass() {
      const t = this.getTipElement()
      const e = t.getAttribute('class').match(xt)
      e !== null &&
        e.length > 0 &&
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (
          ...
          (e || (e = new Bt(this, s)), typeof t === 'string')
        ) {
  ...
  const Ut = { ...Bt.DefaultType, content: '(string|element|function)' }
  const qt = {
  ...
  class Ft extends Bt {
    ...
    _cleanTipClass() {
      const t = this.getTipElement()
      const e = t.getAttribute('class').match($t)
      e !== null &&
        e.length > 0 &&
        e.map((t) => t.trim()).forEach((e) => t.classList.remove(e))
    }
  ...
  const Kt = { offset: 'number', method: 'string', target: '(string|element)' }
  class Vt extends z {
    constructor(t, e) {
      super(t),
        (this._scrollElement =
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        const e =
          Vt.getInstance(this) || new Vt(this, typeof t === 'object' ? t : {})
        if (typeof t === 'string') {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`)
          e[t]()
        }
  ...
  class Gt extends z {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (
          (e || (e = new Gt(this, typeof t === 'object' && t)),
          typeof t === 'string')
        ) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`)
          e[t](this)
